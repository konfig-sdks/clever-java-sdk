...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.clever.com/v3.1";
    private String tokenUrl = "https://clever.com/oauth/tokens";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.clever.com/v3.1)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://clever.com/oauth/tokens)
     * @return An instance of OkHttpClient
     */
