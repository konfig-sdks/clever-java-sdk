...
public class Term {
  ...
  **/
   ...
   * @return the Term instance itself
   */
  public Term putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.district, term.district) &&
        ...
        Objects.equals(this.additionalProperties, term.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(district, endDate, id, name, startDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Term
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Term.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("start_date").isJsonNull() && (jsonObj.get("start_date") != null && !jsonObj.get("start_date").isJsonNull()) && !jsonObj.get("start_date").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Term>() {
           ...
           public Term read(JsonReader in) throws IOException {
             ...
             Term instance = thisAdapter.fromJsonTree(jsonObj);
