...
public class Staff {
  ...
  **/
   ...
   * @return the Staff instance itself
   */
  public Staff putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Staff staff = (Staff) o;
    return Objects.equals(this.title, staff.title) &&
        Objects.equals(this.credentials, staff.credentials) &&
        ...
        Objects.equals(this.additionalProperties, staff.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, credentials, department, ext, legacyId, roles, schools, staffId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Staff.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Staff>() {
           ...
           public Staff read(JsonReader in) throws IOException {
             ...
             Staff instance = thisAdapter.fromJsonTree(jsonObj);
