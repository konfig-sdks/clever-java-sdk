...
public class Course {
  ...
  **/
   ...
   * @return the Course instance itself
   */
  public Course putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.district, course.district) &&
        ...
        Objects.equals(this.additionalProperties, course.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(district, id, name, number, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Course>() {
           ...
           public Course read(JsonReader in) throws IOException {
             ...
             Course instance = thisAdapter.fromJsonTree(jsonObj);
