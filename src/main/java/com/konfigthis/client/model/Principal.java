...
public class Principal {
  ...
  **/
   ...
   * @return the Principal instance itself
   */
  public Principal putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, principal.email) &&
        ...
        Objects.equals(this.additionalProperties, principal.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Principal>() {
           ...
           public Principal read(JsonReader in) throws IOException {
             ...
             Principal instance = thisAdapter.fromJsonTree(jsonObj);
