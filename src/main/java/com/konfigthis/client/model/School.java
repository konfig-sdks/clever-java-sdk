...
import com.konfigthis.client.model.Principal;
...
public class School {
  ...
  **/
   ...
   * @return the School instance itself
   */
  public School putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, school.created) &&
        ...
        Objects.equals(this.additionalProperties, school.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, district, ext, highGrade, id, lastModified, location, lowGrade, mdrNumber, name, ncesId, phone, principal, schoolNumber, sisId, stateId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to School
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!School.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("high_grade").isJsonNull() && (jsonObj.get("high_grade") != null && !jsonObj.get("high_grade").isJsonNull()) && !jsonObj.get("high_grade").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("low_grade").isJsonNull() && (jsonObj.get("low_grade") != null && !jsonObj.get("low_grade").isJsonNull()) && !jsonObj.get("low_grade").isJsonPrimitive()) {
      ...
      if (jsonObj.get("principal") != null && !jsonObj.get("principal").isJsonNull()) {
        Principal.validateJsonObject(jsonObj.getAsJsonObject("principal"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<School>() {
           ...
           public School read(JsonReader in) throws IOException {
             ...
             School instance = thisAdapter.fromJsonTree(jsonObj);
