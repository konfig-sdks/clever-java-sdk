...
public class ResourceResponse {
  ...
  **/
   ...
   * @return the ResourceResponse instance itself
   */
  public ResourceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, resourceResponse.data)&&
        Objects.equals(this.additionalProperties, resourceResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Resource.validateJsonObject(jsonObj.getAsJsonObject("data"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceResponse>() {
           ...
           public ResourceResponse read(JsonReader in) throws IOException {
             ...
             ResourceResponse instance = thisAdapter.fromJsonTree(jsonObj);
